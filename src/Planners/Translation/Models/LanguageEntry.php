...
class LanguageEntry extends PlannersModel
{
    ...
    {
        return $this->belongsTo('Planners\Translation\Models\Language');
    }

    /**
     *  Return the language entry in the default language that corresponds to this entry.
     *  @param Planners\Translation\Models\Language  $defaultLanguage
     *  @return Planners\Translation\Models\LanguageEntry
     */
     ...
     *
     *  @param Planners\Translation\Models\Language
     *  @return Planners\Translation\Models\LanguageEntry
     */
