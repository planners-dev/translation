<?php
namespace Planners\Translation;

use Illuminate\Translation\TranslationServiceProvider as LaravelTranslationServiceProvider;
use Planners\Translation\Facades\Translator;
use Planners\Translation\Loaders\DatabaseLoader;
use Planners\Translation\Loaders\FileLoader;
use Planners\Translation\Loaders\MixedLoader;
use Planners\Translation\Providers\LanguageEntryProvider;
use Planners\Translation\Providers\LanguageProvider;
...
class TranslationServiceProvider extends LaravelTranslationServiceProvider
{
    ...
    {
        $this->package('planners/translation', 'planners/translation', __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..');
    ...
    protected function registerLoader()
    {
        ...
        $this->app['translation.loader'] = $this->app->share(function ($app) {
            $languageProvider = new LanguageProvider($app['config']['planners/translation::language.model']);
            $langEntryProvider = new LanguageEntryProvider($app['config']['planners/translation::language_entry.model']);

            $mode = $app['config']['planners/translation::mode'];
