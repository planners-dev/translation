<?php
namespace Planners\Translation\Providers;
...
class LanguageEntryProvider
{
     ...
     *    @var string
     */
    protected $model = 'Planners\Translation\Models\LanguageEntry';
     ...
     *    @param Planners\Translation\Models\Language                 $reference
     *    @param Planners\Translation\Models\Language                 $target
